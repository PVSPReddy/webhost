...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    if($shallAllow==true)
    {
        try
        {
            ...
            $sql = "INSERT INTO webhostdb.userinfo (uname, password, first_name, last_name, mobile_no, email_id, profile_pic ) VALUES ( '$uName', '$uPwd', '$uFName', '$uLName->last_name', '$uMobileNo', '$uEmailId', 'no pic' )";
            $connn->exec($sql);
